...
async function injectRecaptchaFields(e, t, r, n=!1, i=!1) {
    const s = new RecaptchaEnterpriseVerifier(e);
    let o;
    if (i)
        o = "NO_RECAPTCHA";
    else
...
async function handleRecaptchaFlow(e, t, r, n, i) {
    ...
    if ("EMAIL_PASSWORD_PROVIDER" === i) {
        if (null === (s = e._getRecaptchaConfig()) || void 0 === s ? void 0 : s.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")) {
    ...
    if ("PHONE_PROVIDER" === i) {
        if (null === (o = e._getRecaptchaConfig()) || void 0 === o ? void 0 : o.isProviderEnabled("PHONE_PROVIDER")) {
            ...
            return n(e, i).catch((async i => {
                var s;
                if ("AUDIT" === (null === (s = e._getRecaptchaConfig()) || void 0 === s ? void 0 : s.getProviderEnforcementState("PHONE_PROVIDER")) && ("auth/missing-recaptcha-token" === i.code || "auth/invalid-app-credential" === i.code)) {
...
async function _initializeRecaptchaConfig(e) {
    ...
    if (null == t.tenantId ? t._agentRecaptchaConfig = n : t._tenantRecaptchaConfigs[t.tenantId] = n,
    n.isAnyProviderEnabled()) {
...
async function sendPasswordResetEmail(e, t, r) {
    ...
    await handleRecaptchaFlow(n, i, "getOobCode", sendPasswordResetEmail$1, "EMAIL_PASSWORD_PROVIDER")
}
...
async function createUserWithEmailAndPassword(t, r, n) {
    ...
    const i = _castAuth(t)
      , s = handleRecaptchaFlow(i, {
        ...
        password: n,
        clientType: "CLIENT_TYPE_WEB"
    }, "signUpPassword", signUp, "EMAIL_PASSWORD_PROVIDER")
      , o = await s.catch((e => {
...
async function sendSignInLinkToEmail(e, t, r) {
    ...
    await handleRecaptchaFlow(n, i, "getOobCode", sendSignInLinkToEmail$1, "EMAIL_PASSWORD_PROVIDER")
}
...
function initializeRecaptchaConfig(e) {
    return _initializeRecaptchaConfig(e)
}
...
const C = BrowserLocalPersistence;
    ...
    try {
        ...
        "session"in i) {
            ...
            if ("phoneNumber"in i) {
                ...
                const n = {
                  ...
                  , s = handleRecaptchaFlow(e, n, "mfaSmsEnrollment", (async (e, t) => {
                    if ("NO_RECAPTCHA" === t.phoneEnrollmentInfo.captchaResponse) {
                        _assert("recaptcha" === (null == r ? void 0 : r.type), e, "argument-error");
                        return startEnrollPhoneMfa(e, await injectRecaptchaV2Token(e, t, r))
                    }
                    return startEnrollPhoneMfa(e, t)
                }
                ), "PHONE_PROVIDER");
            ...
            }
            {
                ...
                const s = (null === (n = i.multiFactorHint) || void 0 === n ? void 0 : n.uid) || i.multiFactorUid;
                _assert(s, e, "missing-multi-factor-info");
                const o = {
                  ...
                  , a = handleRecaptchaFlow(e, o, "mfaSmsSignIn", (async (e, t) => {
                    if ("NO_RECAPTCHA" === t.phoneSignInInfo.captchaResponse) {
                        _assert("recaptcha" === (null == r ? void 0 : r.type), e, "argument-error");
                        return startSignInPhoneMfa(e, await injectRecaptchaV2Token(e, t, r))
                    }
                    return startSignInPhoneMfa(e, t)
                }
                ), "PHONE_PROVIDER");
        ...
        }
        {
            const t = {
              ...
              , n = handleRecaptchaFlow(e, t, "sendVerificationCode", (async (e, t) => {
                if ("NO_RECAPTCHA" === t.captchaResponse) {
                    _assert("recaptcha" === (null == r ? void 0 : r.type), e, "argument-error");
                    return sendPhoneVerificationCode(e, await injectRecaptchaV2Token(e, t, r))
                }
                return sendPhoneVerificationCode(e, t)
            }
            ), "PHONE_PROVIDER");
            return (await n.catch((e => Promise.reject(e)))).sessionInfo
        }
    } finally {
        null == r || r._reset()
    }
...
async function injectRecaptchaV2Token(e, t, r) {
    _assert("recaptcha" === r.type, e, "argument-error");
    const n = await r.verify();
    _assert("string" == typeof n, e, "argument-error");
...
function registerAuth(e) {
    ...
    r(K, "1.8.0", function getVersionForPlatform(e) {
        switch (e) {
        case "Node":
            return "node";
        case "ReactNative":
